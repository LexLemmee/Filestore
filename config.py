...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6251112181:AAFFWet-f0_Ij-AgPVPwSJZlM-imDPaSOKs")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001472710236"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001450100536"))
...
try:
    ADMINS=[1983425967]
    for x in (os.environ.get("ADMINS", "5834922260 753586683").split()):
        ADMINS.append(int(x))
except ValueError:
